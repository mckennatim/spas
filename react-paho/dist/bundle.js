...
exports.cfg = exports.dog = undefined;

var _envmy = __webpack_require__(5);
...
var cfg = _env2.default[_envmy2.default.m || 'local'];
...
function onConnect() {
	console.log('Connected to ' + _funcs.cfg.mqtt_server + ' on port ' + _funcs.cfg.mqtt_port + ' ');
	subscribe();
...
client = new Paho.Client(_funcs.cfg.mqtt_server, _funcs.cfg.mqtt_port, _funcs.cfg.appid + Math.random());
...
module.exports = {
	"local": {
		...
		"spa": "http://71.192.254.240/spas/cascada/dist/",
